...
from PySide6.QtGui import Qt, QPolygon, QPainter, QBrush, QPen
from PySide6.QtCore import QTimer, QPoint, QTime,QRect
import sys
    ...
    def paintEvent(self, event):
        ...
        for i in range(0, 60):
            ...
            if (i % 5) == 0:
                ...
                rectangle=QRect(-10,-80,20,20)
                num=12 if i/5==0 else int(i/5)
                painter.drawText(rectangle,Qt.Alignment.AlignCenter,str(num))
